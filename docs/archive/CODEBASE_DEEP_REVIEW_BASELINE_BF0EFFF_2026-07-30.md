# Archived Utopia Deep Review

> Historical narrative audit. Findings were initially established against
> `bf0efff` and later annotated during the `0b340b1` remediation review. This
> file is preserved for provenance, not as a statement of current defects.
> Use `docs/CODEBASE_DEEP_REVIEW_2026-07-30.md` for current risk.
