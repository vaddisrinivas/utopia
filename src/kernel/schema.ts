...
const DependencyPinSchema = z.object({
  package: Id,
  version: Id,
  source: z.enum(['npm', 'maven', 'gradle', 'cocoapods', 'other']).optional(),
});
const NativeCapabilitiesSchema = z.object({
...
export const PackageSchema = z.object({
  ...
  dependencyPins: z.array(DependencyPinSchema),
  nativeCapabilities: NativeCapabilitiesSchema,
  contractLock: z.object({
    ...
    nativeCapabilities: NativeCapabilitiesSchema.optional(),
  }).strict(),
