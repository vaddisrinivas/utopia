...
export const sourceRows = [
  ['Notion', 'Configured', 'Template snapshot', 'Utopia 2026'],
  ['Google Sheets', 'Configured', 'Workbook snapshot', 'Utopia Master'],
